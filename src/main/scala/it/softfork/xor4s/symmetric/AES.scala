package it.softfork.xor4s.symmetric
...
object AES {
  ...
  val SBOX: Array[Array[Byte]] = Array(
  ...
  val INVERSE_SBOX: Array[Array[Byte]] = Array(
  ...
  def addRoundKey(state: Array[Array[Byte]], key: Array[Byte]): Array[Array[Byte]] = {
    for (i <- 0 to 3) {
      for (j <- 0 to 3) {
  ...
  def subBytes(state: Array[Array[Byte]]): Array[Array[Byte]] = {
    for (i <- 0 to 3) {
      for (j <- 0 to 3) {
        state(i)(j) = SBOX((state(i)(j) >> 4).toInt)((state(i)(j) & 0x0F).toInt)
      }
    }
  ...
  def invSubBytes(state: Array[Array[Byte]]): Array[Array[Byte]] = {
    for (i <- 0 to 3) {
      for (j <- 0 to 3) {
        state(i)(j) = INVERSE_SBOX((state(i)(j) >> 4).toInt)((state(i)(j) & 0x0F).toInt)
      }
    }
  ...
  def shiftRows(state: Array[Array[Byte]]): Array[Array[Byte]] = {
  ...
  def invShiftRaws(state: Array[Array[Byte]]): Array[Array[Byte]] = {
  ...
  def mixColumns(state: Array[Array[Byte]]): Array[Array[Byte]] = {
    for (i <- 0 to 3) {
  ...
  def invMixColumns(state: Array[Array[Byte]]): Array[Array[Byte]] = {
    for (i <- 0 to 3) {
      val col = Array(state(0)(i), state(1)(i), state(2)(i), state(3)(i))
